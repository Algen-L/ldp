    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            new TomSelect("#competency-select", {
                ...
                maxItems: 5, // Allow selecting multiple
