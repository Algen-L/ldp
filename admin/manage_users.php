...
<body>
    ...
    <div id="deleteModal" class="modal-overlay">
        <div class="delete-modal"
            style="background: white; max-width: 400px; border-radius: 24px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);">
            <div class="modal-header-danger" style="background: #fff1f2; padding: 30px; text-align: center;">
                <div class="danger-icon-circle"
                    style="width: 60px; height: 60px; background: #fee2e2; color: #ef4444; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.75rem; margin: 0 auto 16px;">
